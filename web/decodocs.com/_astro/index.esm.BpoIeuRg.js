import{L as qn,t as Kt,u as Gn,v as zn,i as Tt,C as wt,r as yt,w as Kn,S as de,E as Xe,g,x as h,y as jn,z as jt,A as v,F as Qe,B as $n,G as Y,H as Ze,I as ee,J as te,K as $e,M as Bn,N as Yn,e as $t,O as Jn,m as Xn,P as Qn,Q as Zn,R as ei}from"./index.esm.DAC6xlWs.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ke=new qn("@firebase/auth");function ii(n,...e){ke.logLevel<=jt.WARN&&ke.warn(`Auth (${de}): ${n}`,...e)}function we(n,...e){ke.logLevel<=jt.ERROR&&ke.error(`Auth (${de}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class he{constructor(e,t){this.shortDelay=e,this.longDelay=t,C(t>e,"Short delay should be less than long delay!"),this.isMobile=Gn()||zn()}get(){return ri()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
