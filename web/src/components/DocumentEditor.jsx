  ...
  return (
    <Layout variant="app" showFooter={false}>
      <div className="flex flex-col h-full bg-slate-100">
        ...
        {/* Top Toolbar - Smallpdf Style */}
        <div className="h-16 bg-white border-b border-slate-200 px-4 flex items-center justify-between shadow-sm z-20 relative font-sans">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-slate-800 text-lg leading-tight">{selectedDocument?.name || 'Untitled Document'}</span>
              <span className="text-xs text-slate-500">Edit Mode</span>
            </div>
          </div>

          {/* Center: Tools */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2 bg-slate-50 p-1.5 rounded-xl border border-slate-200 shadow-sm">
            <ToolButton
            ...
            <ToolButton
              ...
              icon={HiPhotograph}
              label="Image"
              onClick={() => setActiveTool('image')} // Placeholder
            ...
            <ToolButton
              ...
              icon={HiTemplate}
              label="Shapes"
              onClick={() => setActiveTool('shape')} // Placeholder
              tooltip="Add Shapes"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-600/20 transition-all hover:-translate-y-0.5 active:translate-y-0">
              Finish & Download <HiDownload className="w-5 h-5" />
            </button>
          </div>
        </div>
